...
export default {
    ...
    methods: {
        ...
        loadProject() {
            ...
            service.get('https://cors-anywhere.herokuapp.com/https://testacciona.azurewebsites.net/api/Projects', { id }).then(response => {
        ...
        saveProject() {
            ...
            service[method]('https://cors-anywhere.herokuapp.com/https://testacciona.azurewebsites.net/api/Projects', this.project).then(response => {
                if (this.new) {
        ...
        // Borra un proyecto
        deleteProject() {
            service.delete('https://cors-anywhere.herokuapp.com/https://testacciona.azurewebsites.net/api/Projects').then(() => {
